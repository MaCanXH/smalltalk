...
- **App installed but shows old JS**: the dev build only needs reinstalling (`npm run android`) when native deps or `app.json` plugins change; JS-only changes just need Metro.
